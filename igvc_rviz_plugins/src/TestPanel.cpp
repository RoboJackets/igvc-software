#include <igvc_rviz_plugins/TestPanel.h>
#include <QVBoxLayout>
  ...
  : rviz::Panel(parent) // Base class constructor
{
    ...
    */
    speed_subscriber = handle.subscribe<igvc_msgs::velocity_pair>("/encoders", 1, boost::bind(&TestPanel::subCallback, this, _1, label));
...
void TestPanel::subCallback(const igvc_msgs::velocity_pairConstPtr &msg, QLabel *label) {
 ...
 */
PLUGINLIB_EXPORT_CLASS( igvc_rviz_plugins::TestPanel, rviz::Panel)
