...
public class ServerMessage {
	...
	public static ServerMessage receive(Socket clientSock) throws IOException {
	...
	private static String readNextField(BufferedReader inStream, int size)
			throws IOException {
		int count = 0;
		int c = 0;
		String input = "";
	...
	public void send(Socket clientSock) throws IOException {
		...
		while (typeStr.length() < 9) {
			typeStr = '0' + typeStr;
		}
		while (id_lenStr.length() < 9) {
			id_lenStr = '0' + id_lenStr;
		}
		while (lenStr.length() < 9) {
			lenStr = '0' + lenStr;
		}
	...
	public ServerMessage(int t, String id, String data) {
