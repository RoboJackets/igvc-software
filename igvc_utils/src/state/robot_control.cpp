...
CurvatureVelocity RobotControl::toKV(const std::optional<double> &axle_length) const
{
...
double RobotControl::angularVelocity(const std::optional<double> &axle_length) const
{
  return (right_ - left_) / axle_length.value_or(axle_length_);
}
