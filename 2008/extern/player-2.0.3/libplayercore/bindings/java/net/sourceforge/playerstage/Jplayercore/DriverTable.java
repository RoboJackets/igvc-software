...
public class DriverTable {
  ...
  public int AddDriver(String name, SWIGTYPE_p_f_p_ConfigFile_int__p_Driver initfunc) {
    return playercore_javaJNI.DriverTable_AddDriver(swigCPtr, name, SWIGTYPE_p_f_p_ConfigFile_int__p_Driver.getCPtr(initfunc));
  }

  public DriverEntry GetDriverEntry(String name) {
    long cPtr = playercore_javaJNI.DriverTable_GetDriverEntry(swigCPtr, name);
    return (cPtr == 0) ? null : new DriverEntry(cPtr, false);
  }

  public int Size() {
    return playercore_javaJNI.DriverTable_Size(swigCPtr);
  }

  public String GetDriverName(int idx) {
    return playercore_javaJNI.DriverTable_GetDriverName(swigCPtr, idx);
  }

  public SWIGTYPE_p_p_char SortDrivers() {
    long cPtr = playercore_javaJNI.DriverTable_SortDrivers(swigCPtr);
