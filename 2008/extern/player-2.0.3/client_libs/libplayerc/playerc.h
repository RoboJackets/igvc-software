...
typedef struct
{
  ...
  */
  ...
  // DAVID: Add support for WaitForNewImage()
  volatile int curImageID;              // access synchronized with hasnewimage_mutex
  volatile int seenImageID;             // access synchronized with hasnewimage_mutex
  pthread_mutex_t hasnewimage_mutex;
  pthread_cond_t hasnewimage_cond;
...
// DAVID: Add support for WaitForNewImage()
/** @brief Waits until a new camera image has been received. */
void playerc_camera_waitfornewimage(playerc_camera_t *device);

// DAVID: Add support for WaitForNewImage()
/** @brief Returns whether a new camera image has been received. */
int playerc_camera_hasnewimage(playerc_camera_t *device);

// DAVID: Add support for WaitForNewImage()
/** @brief Signals that the camera image has been received. */
