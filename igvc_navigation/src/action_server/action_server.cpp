...
ActionServer::ActionServer()
{
  ...
  rviz_sub_ = nh.subscribe("/move_base_simple/goal", 1, &ActionServer::actionCallbackPose, this);
  waypoint_sub_ = nh.subscribe("/waypoint", 1, &ActionServer::actionCallbackPoint, this);
}
