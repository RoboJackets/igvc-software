...
{
public:
  void proposal_distribution(const igvc_msgs::velocity_pairConstPtr& motor_command) override;
  void getWeights(const pcl::PointCloud<pcl::PointXYZ>::ConstPtr &pointCloud, igvc_msgs::mapConstPtr map_ptr) override;
