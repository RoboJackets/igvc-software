...
IF((${ROBOT_REV} MATCHES "candiiidbg") OR (${ROBOT_REV} MATCHES "jeannidbg"))
	SET(CMAKE_C_FLAGS  "-march=native -pipe -Wall -Wstrict-prototypes -Wextra -ggdb3 -O0 -pthread -DOSMC_4WD -fopenmp -p")
	SET(CMAKE_CXX_FLAGS "-march=native -pipe -Wall -Wextra -ggdb3 -O0 -pthread -DOSMC_4WD  -fopenmp -rdynamic -g -p")
