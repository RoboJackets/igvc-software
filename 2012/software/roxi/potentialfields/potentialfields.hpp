...
private:
	...
	const static int obstacle_avoid_radius = 0;		 	// Radius around the robot in which the robot considers those obstacles 
	...
	const static double guessed_min_potential = 500;		// Potential used in calculation of heuristic
