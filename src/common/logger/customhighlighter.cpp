    ...
    : QSyntaxHighlighter(parent)
{
    ...
    foreach (const QString &pattern, customRedKeywordPatterns) {
        rule.pattern = QRegExp(pattern);
    ...
    foreach (const QString &pattern, customDarkYellowKeywordPatterns) {
        rule.pattern = QRegExp(pattern);
    ...
    foreach (const QString &pattern, customDarkBlueKeywordPatterns) {
        rule.pattern = QRegExp(pattern);
