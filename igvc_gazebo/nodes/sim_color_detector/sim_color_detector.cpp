...
sensor_msgs::CameraInfo SimColorDetector::scaleCameraInfo(const sensor_msgs::CameraInfo& camera_info, int width, int height)
{
...
void SimColorDetector::handleImage(const sensor_msgs::ImageConstPtr& msg, const sensor_msgs::CameraInfoConstPtr& camera_info, std::string camera_name)
{
