...
/* Detect endianness */
     ...
     defined(__ARMEL__) || defined(__THUMBEL__) || defined(__AARCH64EL__) || defined(_MIPSEL) || defined(_M_IX86) ||   \
...
#define PB_BIND(msgname, structname, width)                                                                            \
  const uint32_t structname##_field_info[] PB_PROGMEM = { msgname##_FIELDLIST(PB_GEN_FIELD_INFO_##width,               \
                                                                              structname) 0 };                         \
