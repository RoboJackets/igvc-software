...
SegmentedCameraInfoPublisher::SegmentedCameraInfoPublisher() : pNh{ "~" }
{
  ...
  for (size_t i = 0; i < camera_names.size(); i++)
  {
    ...
    subs.push_back(
        nh.subscribe<sensor_msgs::CameraInfo>(semantic_info_topic, 10,
                                              boost::bind(&SegmentedCameraInfoPublisher::ScaleCameraInfo, this, _1,
                                                          output_width, output_height, camera_name)));
                                                   ...
                                                   double height, std::string camera_name)
{
  ...
  changed_camera_info.K = { camera_info->K[0] * w_ratio,
                            ...
                            0,
                            1 };
  changed_camera_info.P = { camera_info->P[0] * w_ratio,
                            0,
