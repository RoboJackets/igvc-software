...
#             print(camera_name)
#
#             cam_frame_name = camera_name + "_optical"
...
#     def __init__(self, camera_names, segmented_image_topics, publisher_topic, model_filename, resize_width,
#             resize_height, force_cpu, line_thresh):
#
#         self.bridge = CvBridge()
#
...
#             # Use the same callback for every camera.
#             self.subscribers.append(rospy.Subscriber(segmented_image_topic, ImMsg, functools.partial(self.segmented_image_cb, camera_name), queue_size=1, buff_size=10**8))
#         rospy.loginfo('Line detector is running.')
#
#     # This function projects image pixels into world coordinates using a flat plane assumption.
#     def init_point_cloud_array(self, camera_name):
