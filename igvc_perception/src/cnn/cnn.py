...
class CNN():
    ...
    def __init__(self, camera_names, publisher_topic, model_filename, resize_width,
        ...
        self.graph = torch.load(model_filename)
        ...
        self.cam_transform_trainslations = {}
        self.world_points_arrays = {}
        self.subscribers = []
        ...
        for camera_name in camera_names:
            ...
            # TODO: transform for other cameras?
            ...
            self.subscribers.append(rospy.Subscriber('/%s/image_raw' % camera_name, Image, functools.partial(self.image_cb, camera_name), queue_size=1, buff_size=10**8))
    ...
    def init_point_cloud_array(self, camera_name):
        ...
        cam_transform_translation = self.cam_transform_translation[camera_name]
        ...
        self.world_point_array[camera_name] = world_points_array
    ...
    def image_cb(self, camera_name, data):
        ...
        image_np = cv2.resize(image_np, dsize=(self.model_width,self.model_height))
        ...
        output_data = output.cpu().data.numpy()[0]

        threshold = 0.5
        im_threshold = output_data > threshold

        world_points = self.world_point_array[camera_name][im_threshold]
