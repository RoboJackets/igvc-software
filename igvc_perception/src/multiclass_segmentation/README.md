...
3. Run `python make_dataset.py -a /path_to_images(png) -b /path_to_masks(json)`to generate .npy files. Example: `python make_dataset.py -a annotations/**/*.png -b annotations/**/*.json`
