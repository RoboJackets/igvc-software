...
void loop();
void ReadFromSerial();
void ReadCmd(int mode, int id);
void RangeCmd(int mode, int id);
void SendRangeToProcessing(int index, int Val);
int Range_MmToBin(int val);
int ByteSmasher(byte byteUpper, byte byteLower);
void SetMaxRange(byte Addr, byte RangeVal);
void SetMaxGain(byte Addr, byte RangeVal);
void StartRange(int Addr);
int GetRange(int Addr, int EchoNum);
