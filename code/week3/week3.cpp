...
int main()
{
  ...
  cout << "robo_vector has a capacity of " << robo_vector.capacity() << " and a size of " << robo_vector.size() << endl;
  ...
  cout << "after reserve 30 robo_vector has a capacity of " << robo_vector.capacity() << " and a size of "
       << robo_vector.size() << endl;

  // if resize is called on a size smaller it does nothing
  robo_vector.reserve(10);
  cout << "after reserve 10 robo_vector has a capacity of " << robo_vector.capacity() << " and a size of "
       << robo_vector.size() << endl;
