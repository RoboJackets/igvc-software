#include "JoystickMB.h"
#include <fcntl.h>
#include <poll.h>
#include <errno.h>
#include <linux/joystick.h>

JoystickMB::JoystickMB()
{
    ...
    if(_joystick_fd < 0)
    {
        ...
        _iothread = boost::thread(boost::bind(&JoystickMB::threadRun, this));
    }
}

void JoystickMB::threadRun()
{
    while(_isOpen)
    {
        struct pollfd pfd;
